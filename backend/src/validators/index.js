...
export const createElectionValidator = [
  ...
  body("startTime")
    ...
    .isNumeric()
    .withMessage("Start time must be a timestamp"),

  body("endTime")
    .notEmpty()
    .withMessage("End time is required")
    .isNumeric()
    .withMessage("End time must be a timestamp")
    .custom((value, { req }) => {
...
export const addCandidateValidator = [
  body("electionId")
    ...
    .isInt({ min: 0 })
    .withMessage("Election ID must be a positive number"),
...
export const registerVoterValidator = [
  body("electionId")
    ...
    .withMessage("Election ID is required")
    .isInt({ min: 0 })
    .withMessage("Election ID must be valid"),
